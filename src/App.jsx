...
function Nav() {
  return (
    <nav className="border-b border-[#EBEBEB] bg-[#FAFAFA] sticky top-0 z-50">
...
function Hero() {
  return (
    <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 grid md:grid-cols-2 gap-12 items-center">
      {/* Text */}
      <div>
        <p className="text-xs font-semibold tracking-[0.12em] uppercase text-[#8DAA44] mb-6">
          Product Designer · Strategist · Solopreneur
        </p>
        <h1 className="font-serif font-bold text-[#1A1730] leading-tight mb-6" style={{ fontSize: 'clamp(44px, 6vw, 72px)' }}>
          Hi, I'm Lisa<span style={{ color: PURPLE }}>.</span>
        </h1>
        <p className="text-base leading-relaxed text-[#1A1730] opacity-75 mb-8 max-w-lg">
        ...
        <p className="text-sm text-[#1A1730] opacity-60 mb-10 max-w-md">
          Currently building{' '}
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20">
      <div className="mb-12">
        ...
        <h2 className="font-serif font-bold text-[#1A1730] leading-tight" style={{ fontSize: 'clamp(34px, 4vw, 54px)' }}>
          Things I'm<br />
          <em className="text-[#5C3AFF]">Building.</em>
        </h2>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#EBEBEB] border border-[#EBEBEB] mb-14">
        {[
          ...
          <div key={label} className="bg-white px-8 py-8">
            <div className="font-serif font-bold text-[#5C3AFF] mb-1" style={{ fontSize: 40 }}>{num}</div>
